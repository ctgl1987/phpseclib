 ...
 * DER blobs.
 *
 * \phpseclibXD\File\ASN1 decodes and encodes DER formatted messages and places them in a semantic context.
 *
...
abstract class ASN1
{
     ...
     *
     * Structured or unknown types are mapped to a \phpseclibXD\File\ASN1\Element.
   ...
   const STRING_TYPE_SIZE = [
     ...
     * Set filters
     *
     * See \phpseclibXD\File\X509, etc, for an example.
