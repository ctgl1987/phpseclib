 ...
 *
 *    $agent = new \phpseclibXD\System\SSH\Agent();
 *
...
namespace phpseclibXD\System\SSH;

use phpseclibXD\Common\Functions\Strings;
use phpseclibXD\Crypt\PublicKeyLoader;
use phpseclibXD\Crypt\RSA;
use phpseclibXD\Exception\BadConfigurationException;
use phpseclibXD\System\SSH\Agent\Identity;

/**
 * Pure-PHP ssh-agent client identity factory
 *
 * requestIdentities() method pumps out \phpseclibXD\System\SSH\Agent\Identity objects
 *
 * @package SSH\Agent
 * @author  Jim Wigginton <terrafrost@php.net>
 * @access  public
...
class Agent
{
     ...
     * Default Constructor
     *
     * @return \phpseclibXD\System\SSH\Agent
     * @throws \phpseclibXD\Exception\BadConfigurationException if SSH_AUTH_SOCK cannot be found
     ...
     * Returns an array containing zero or more \phpseclibXD\System\SSH\Agent\Identity objects
     *
     * @return array
     ...
     *
     * @param \phpseclibXD\Net\SSH2 $ssh
     * @return bool
     * @access public
     */
