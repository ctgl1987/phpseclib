...
namespace phpseclibXD\System\SSH\Agent;
 ...
 *
 * Instantiation should only be performed by \phpseclibXD\System\SSH\Agent class.
 * This could be thought of as implementing an interface that phpseclibXD\Crypt\RSA
...
{
    use \phpseclibXD\System\SSH\Common\Traits\ReadBytes;
     ...
     * @return \phpseclibXD\System\SSH\Agent\Identity
     * @access private
     */
     ...
     * Set Public Key
     *
     * Called by \phpseclibXD\System\SSH\Agent::requestIdentities()
     *
     * @param \phpseclibXD\Crypt\Common\PublicKey $key
     * @access private
     */
     ...
     * Set Public Key
     *
     * Called by \phpseclibXD\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key
