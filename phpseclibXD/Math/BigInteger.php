 ...
 * <code>
 * <?php
 *    $a = new \phpseclibXD\Math\BigInteger(2);
 *    $b = new \phpseclibXD\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
class BigInteger
{
    ...
    public static function setEngine($main, $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'phpseclibXD\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \phpseclibXD\Math\BigInteger('10');
     *    $b = new \phpseclibXD\Math\BigInteger('20');
     *
