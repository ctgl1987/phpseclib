 ...
 *
 *    $des = new \phpseclibXD\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends BlockCipher
{
     ...
     * @see \phpseclibXD\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**
   ...
   protected $key_length = 8;
     ...
     *
     * @see \phpseclibXD\Crypt\Common\SymmetricKey::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \phpseclibXD\Crypt\Common\SymmetricKey::isValidEngine()
     * @param int $engine
     * @access protected
     * @return bool
     */
