 ...
 *
 *    echo bin2hex(\phpseclibXD\Crypt\Random::string(8));
 * ?>
 * </code>
 *
 * @category  Crypt
...
abstract class Random
{
    ...
    public static function string($length)
    {
        ...
        if ($crypto === false) {
            ...
            switch (true) {
                case class_exists('\phpseclibXD\Crypt\AES'):
                    $crypto = new AES('ctr');
                    break;
                case class_exists('\phpseclibXD\Crypt\Twofish'):
                    $crypto = new Twofish('ctr');
                    break;
                case class_exists('\phpseclibXD\Crypt\Blowfish'):
                    $crypto = new Blowfish('ctr');
                    break;
                case class_exists('\phpseclibXD\Crypt\TripleDES'):
                    $crypto = new TripleDES('ctr');
                    break;
                case class_exists('\phpseclibXD\Crypt\DES'):
                    $crypto = new DES('ctr');
                    break;
                case class_exists('\phpseclibXD\Crypt\RC4'):
                    $crypto = new RC4();
                    break;
                default:
