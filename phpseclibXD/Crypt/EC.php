 ...
 *
 * $private = \phpseclibXD\Crypt\EC::createKey('secp256k1');
...
use phpseclibXD\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use phpseclibXD\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use phpseclibXD\Crypt\EC\Curves\Curve25519;
use phpseclibXD\Crypt\EC\Curves\Ed25519;
use phpseclibXD\Crypt\EC\Curves\Ed448;
use phpseclibXD\Crypt\EC\Formats\Keys\PKCS1;
use phpseclibXD\Crypt\EC\Parameters;
use phpseclibXD\Crypt\EC\PrivateKey;
use phpseclibXD\Crypt\EC\PublicKey;
use phpseclibXD\Exception\UnsupportedAlgorithmException;
use phpseclibXD\Exception\UnsupportedCurveException;
use phpseclibXD\Exception\UnsupportedOperationException;
use phpseclibXD\File\ASN1;
use phpseclibXD\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
     ...
     * Curve
     *
     * @var \phpseclibXD\Crypt\EC\BaseCurves\Base
     */
    protected $curve;
     ...
     *
     * @var \phpseclibXD\Math\BigInteger
     */
    protected $q;
     ...
     * @access public
     * @param string $curve
     * @return \phpseclibXD\Crypt\EC\PrivateKey
     */
    public static function createKey($curve)
    {
        ...
        $curve = '\phpseclibXD\Crypt\EC\Curves\\' . $curveName;
