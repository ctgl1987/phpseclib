...
use phpseclibXD\Crypt\Common\Formats\Keys\OpenSSH as Progenitor;
...
abstract class OpenSSH extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if ($parsed['type'] == 'ssh-ed25519') {
            ...
            $curveName = '\phpseclibXD\Crypt\EC\Curves\\' . $curveName;
            $curve = new $curveName();
     ...
     * @param \phpseclibXD\Crypt\EC\Curves\Ed25519 $curve
     * @param \phpseclibXD\Math\Common\FiniteField\Integer[] $publicKey
     * @param string $password optional
     * @param array $options optional
     * @return string
