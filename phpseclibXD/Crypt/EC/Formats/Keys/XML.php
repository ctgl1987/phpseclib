...
namespace phpseclibXD\Crypt\EC\Formats\Keys;

use ParagonIE\ConstantTime\Base64;
use phpseclibXD\Common\Functions\Strings;
use phpseclibXD\Crypt\EC\BaseCurves\Base as BaseCurve;
use phpseclibXD\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use phpseclibXD\Crypt\EC\BaseCurves\Prime as PrimeCurve;
...
abstract class XML
{
     ...
     *
     * @param \DOMXPath $xpath
     * @param \phpseclibXD\Crypt\EC\BaseCurves\Base $curve
     * @return object[]
     */
    ...
    /**
     * Returns an instance of \phpseclibXD\Crypt\EC\BaseCurves\Base based
     * on the curve parameters
     *
     * @param \DomXPath $xpath
     * @return \phpseclibXD\Crypt\EC\BaseCurves\Base|false
     */
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\phpseclibXD\Crypt\EC\Curves\\' . $name;
     ...
     *
     * @param \phpseclibXD\Crypt\EC\BaseCurves\Base $curve
     * @param \phpseclibXD\Math\Common\FiniteField\Integer[] $publicKey
