 ...
 *
 * $private = \phpseclibXD\Crypt\RSA::createKey();
...
use phpseclibXD\Crypt\RSA\PrivateKey;
use phpseclibXD\Crypt\RSA\PublicKey;
...
abstract class RSA extends AsymmetricKey
{
     ...
     *
     * @access private
     * @param bool|\phpseclibXD\Math\BigInteger $x
     * @param int $xLen
     * @return bool|string
     */
     ...
     * @access private
     * @param string $x
     * @return \phpseclibXD\Math\BigInteger
     */
    ...
    public function withHash($hash)
    {
        ...
        // \phpseclibXD\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
