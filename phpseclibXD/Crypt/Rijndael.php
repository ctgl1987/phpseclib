 ...
 *
 *    $rijndael = new \phpseclibXD\Crypt\Rijndael('ctr');
 *
...
class Rijndael extends BlockCipher
{
     ...
     * \phpseclibXD\Crypt\Rijndael determines automatically whether mcrypt is useable
     * or not for the current $block_size/$key_length.
     * In case of, $cipher_name_mcrypt will be set dynamically at run time accordingly.
     *
     * @see \phpseclibXD\Crypt\Common\SymmetricKey::cipher_name_mcrypt
     * @see \phpseclibXD\Crypt\Common\SymmetricKey::engine
