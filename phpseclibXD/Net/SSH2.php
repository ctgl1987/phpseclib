 ...
 *
 *    $ssh = new \phpseclibXD\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \phpseclibXD\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \phpseclibXD\Net\SSH2('www.domain.tld');
...
namespace phpseclibXD\Net;

use phpseclibXD\Common\Functions\Strings;
use phpseclibXD\Crypt\Blowfish;
use phpseclibXD\Crypt\ChaCha20;
use phpseclibXD\Crypt\Common\AsymmetricKey;
use phpseclibXD\Crypt\Common\PrivateKey;
use phpseclibXD\Crypt\Common\PublicKey;
use phpseclibXD\Crypt\Common\SymmetricKey;
use phpseclibXD\Crypt\DH;
use phpseclibXD\Crypt\DSA;
use phpseclibXD\Crypt\EC;
use phpseclibXD\Crypt\Hash;
use phpseclibXD\Crypt\Random;
use phpseclibXD\Crypt\RC4;
use phpseclibXD\Crypt\Rijndael;
use phpseclibXD\Crypt\RSA;
use phpseclibXD\Crypt\TripleDES;
use phpseclibXD\Crypt\Twofish;
use phpseclibXD\Exception\ConnectionClosedException;
use phpseclibXD\Exception\InsufficientSetupException;
use phpseclibXD\Exception\NoSupportedAlgorithmsException;
use phpseclibXD\Exception\UnableToConnectException;
use phpseclibXD\Exception\UnsupportedAlgorithmException;
use phpseclibXD\Exception\UnsupportedCurveException;
use phpseclibXD\Math\BigInteger;
use phpseclibXD\Net\SSH2\ChannelConnectionFailureReason;
use phpseclibXD\Net\SSH2\DisconnectReason;
use phpseclibXD\Net\SSH2\MessageType;
use phpseclibXD\Net\SSH2\MessageTypeExtra;
use phpseclibXD\Net\SSH2\TerminalMode;
use phpseclibXD\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \phpseclibXD\Net\SSH2::send_channel_packet()
     * @see \phpseclibXD\Net\SSH2::get_channel_packet()
     * @access private
     */
     ...
     *
     * @access public
     * @see \phpseclibXD\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     * @throws \UnexpectedValueException on receipt of unexpected packets
     * @throws \RuntimeException on other errors
     * @throws \phpseclibXD\Exception\NoSupportedAlgorithmsException when none of the algorithms phpseclib has loaded are compatible
     * @access private
     */
     ...
     * \phpseclibXD\Crypt\Common\SymmetricKey.
     *
     * @param string $algorithm Name of the encryption algorithm
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \phpseclibXD\Crypt\RSA|EC|DSA object, a \phpseclibXD\System\SSH\Agent object or an array
     *
        ...
        foreach ($args as $arg) {
            switch (true) {
                ...
                case Strings::is_stringable($arg):
                    break;
                default:
                    throw new \UnexpectedValueException('$password needs to either be an instance of \phpseclibXD\Crypt\Common\PrivateKey, \System\SSH\Agent, an array or a string');
            }
        }
     ...
     *
     * @param string $username
     * @param \phpseclibXD\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \phpseclibXD\Crypt\Common\PrivateKey $privatekey
     * @return bool
     * @throws \RuntimeException on connection error
     * @access private
     */
        ...
        if ($publickey instanceof RSA) {
            ...
            switch ($curveName) {
                ...
                default:
                    ...
                    throw new UnsupportedCurveException('Named Curve of ' . $curveName . ' is not supported by phpseclibXD\'s SSH2 implementation');
            }
     ...
     * Execute Command
     *
     * If $callback is set to false then \phpseclibXD\Net\SSH2::get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    public function exec($command, callable $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \phpseclibXD\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \phpseclibXD\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
     ...
     * @throws \phpseclibXD\Exception\NoSupportedAlgorithmsException when the key isn't in a supported format
     * @access public
     */
