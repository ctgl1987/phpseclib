...
class Stream
{
    ...
    protected function parse_path($path)
    {
        ...
        if (preg_match('/^{[a-z0-9]+}$/i', $host)) {
            ...
            // casting $pass to a string is necessary in the event that it's a \phpseclibXD\Crypt\RSA object
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \phpseclibXD\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \phpseclibXD\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \phpseclibXD\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \phpseclibXD\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2
