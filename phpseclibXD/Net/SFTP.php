 ...
 *
 *    $sftp = new \phpseclibXD\Net\SFTP('www.domain.tld');
...
use phpseclibXD\Exception\FileNotFoundException;
use phpseclibXD\Net\SFTP\Attribute;
use phpseclibXD\Net\SFTP\FileType;
use phpseclibXD\Net\SFTP\OpenFlag;
use phpseclibXD\Net\SFTP\OpenFlag5;
use phpseclibXD\Net\SFTP\PacketType as SftpPacketType;
use phpseclibXD\Net\SFTP\StatusCode;
use phpseclibXD\Net\SSH2\MessageType as Ssh2MessageType;
...
class SFTP extends SSH2
{
     ...
     *
     * \phpseclibXD\Net\SSH2::exec() uses 0 and \phpseclibXD\Net\SSH2::read() / \phpseclibXD\Net\SSH2::write() use 1.
     *
    ...
    private function init_sftp_connection()
    {
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \phpseclibXD\Net\SFTP would do is close the
    ...
    public function chdir($dir)
    {
        ...
        // see \phpseclibXD\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \phpseclibXD\Net\SFTP::realpath().
     ...
     *
     * By default, \phpseclibXD\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \phpseclibXD\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     *
     * {@internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \phpseclibXD\Net\SFTP::setMode().}
     *
     ...
     * @throws \phpseclibXD\Exception\FileNotFoundException if you're uploading via a file and the file doesn't exist
     * @return bool
     * @access public
     */
