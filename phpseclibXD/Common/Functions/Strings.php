...
namespace phpseclibXD\Common\Functions;

use phpseclibXD\Math\BigInteger;
use phpseclibXD\Math\Common\FiniteField;
            ...
            switch ($format[$i]) {
                ...
                case 'i':
                    if (!$element instanceof BigInteger && !$element instanceof FiniteField\Integer) {
                        throw new \InvalidArgumentException('A phpseclibXD\Math\BigInteger or phpseclibXD\Math\Common\FiniteField\Integer object was expected.');
                    }
