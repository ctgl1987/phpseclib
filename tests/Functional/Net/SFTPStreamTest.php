...
use phpseclibXD\Net\SFTP\Stream;
...
class Functional_Net_SFTPStreamTest extends Functional_Net_SFTPTestCase
{
    ...
    {
        $originalConnectionsCount = count(\phpseclibXD\Net\SSH2::getConnections());
        $session = $this->sftp;
        $dirs = scandir("sftp://$session/");
        $this->assertCount($originalConnectionsCount, \phpseclibXD\Net\SSH2::getConnections());
