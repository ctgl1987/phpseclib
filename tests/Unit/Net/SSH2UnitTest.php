...
class Unit_Net_SSH2UnitTest extends PhpseclibTestCase
{
    ...
    {
        $ssh = new \phpseclibXD\Net\SSH2('localhost');
        $this->assertSame($ssh, \phpseclibXD\Net\SSH2::getConnectionByResourceId($ssh->getResourceId()));
    }
    ...
    /**
     * @return \phpseclibXD\Net\SSH2
     */
    protected function createSSHMock()
    {
        return $this->getMockBuilder('phpseclibXD\Net\SSH2')
